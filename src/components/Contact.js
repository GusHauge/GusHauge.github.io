export const Contact = () => {
  return (
    <div
      id="contact"
      className="flex flex-col w-full h-fit bg-gradient-to-b from-indigo-900 to-black items-center space-y-28 py-14 px-10 pb-32"
    >
      <h1 className="text-6xl font-thin">Contact Me</h1>
